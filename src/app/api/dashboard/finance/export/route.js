...
export async function GET(request) {
  ...
  const sheets = [
    {
      ...
      rows: [
        ...
        ["Periudha", `${formatDate(period.start)} - ${formatDate(period.end)}`],
        ["Të ardhura", income],
    ...
    },
    {
      name: "Shpenzime",
      rows: [
        ["Data", "Kategori", "Përshkrimi", "Furnitori", "Dokumenti", "Mënyra", "Shuma"],
    ...
    },
    {
      name: "Fatura",
      rows: [
        ["Data", "Numri", "Klienti", "Automjeti", "Statusi", "Totali", "Paguar", "Mbetur"],
    ...
    },
    {
      name: "Inventar",
      rows: [
        ["Kodi", "Pjesa", "Kategoria", "Furnitori", "Sasia", "Kosto", "Vlera", "Minimumi"],
        ...parts.map((part) => [
          part.code || "",
          part.name,
          part.category || "",
    ...
    },
    {
      name: "Lëvizje stoku",
      rows: [
        ["Data", "Pjesa", "Lloji", "Sasia", "Para", "Pas", "Përdoruesi", "Shënim"],
  ...
  const fileName = `autoflow-raport-${period.startInput}-${period.endInput}.xlsx`;
