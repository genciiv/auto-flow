...
import { customerConversationAccessWhere } from "@/lib/customer-access";
...
export default async function CustomerConversationPage({ params }) {
  ...
  const messages=await db.chatMessage.findMany({ where:{ conversationId:id, conversation: { is: customerConversationAccessWhere(profileId, id) } }, include:{ sender:{ select:{ id:true,name:true } } }, orderBy:{ createdAt:"asc" }, take:300 });
