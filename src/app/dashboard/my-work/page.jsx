      ...
      <div className="space-y-7">
        <div className="af-page-header">
          <div>
            ...
            <p className="af-page-description">{businessRole === "MECHANIC" ? "Shiko dhe përditëso vetëm urdhër-punët që të janë caktuar." : "Monitoro punët aktive dhe ngarkesën e ekipit."}</p>
          </div>
